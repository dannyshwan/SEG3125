...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        res.render('showResults', {results: [participants, schools, helpful, appeal, improvement, recommend]});
        console.log([participants, schools, helpful, appeal, improvement, recommend]);
    });
